...
Plugin for NOMAD training resources
...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-training-resources.git
cd nomad-training-resources
...
| Name | E-mail     |
|------|------------|
| Siamak Nakhaie | [siamak.nakhaie@physik.hu-berlin.de](mailto:siamak.nakhaie@physik.hu-berlin.de)
